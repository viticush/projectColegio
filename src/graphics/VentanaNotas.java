...
public class VentanaNotas extends javax.swing.JFrame {
    ...
    JOptionPane.WARNING_MESSAGE);
        ...
        nombre = consulta.getDatosProfesor(dni);
        jLabel13.setText(nombre[0]);
        jLabel14.setText(nombre[1]);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        datos[3] = jTextField6.getText();
        datos[4] = jTextField7.getText();
        datos[5] = jTextField11.getText();
        datos[6] = jTextField12.getText();
        datos[7] = jTextField10.getText();
       
        
        consulta.actualizarNotas(datos, dni);
